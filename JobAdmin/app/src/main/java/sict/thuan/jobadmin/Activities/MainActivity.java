...
import sict.thuan.jobadmin.Fragment.HomeFragment;
import sict.thuan.jobadmin.Fragment.NotificationFragment;
import sict.thuan.jobadmin.Fragment.ProfileFragment;
import sict.thuan.jobadmin.Fragment.SearchFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null) {
            ...
            SharedPreferences.Editor editor = getSharedPreferences("thuan", MODE_PRIVATE).edit();
