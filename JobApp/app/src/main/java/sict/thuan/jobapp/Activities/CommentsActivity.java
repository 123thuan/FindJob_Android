...
import sict.thuan.jobapp.Adapter.CommentAdapter;
import sict.thuan.jobapp.Model.Comment;
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(addcomment.getText().toString().equals("")){
                    Toast.makeText(CommentsActivity.this, "không thể gửi bình luận trống rỗng", Toast.LENGTH_SHORT).show();
                } else {
                    addcomment();
                }
            }
